...
from helpers import SpiFlashPeripheral, get_halt_signal, get_io_output_pin, get_output_pin, get_register, is_gate_level_tests, load_binary, assert_registers_zero, run_program, set_input_pin
...
@cocotb.test()
async def test_uart_tx_single_baudrate_2(dut):
    # change baudrate and test uart tx
...
0x00000000	|	0x0280A083	|	lw x1, peripherals
 0x00000004	|	0x0CA00113	|	addi x2, x0, 202
 0x00000008	|	0x00100193	|	addi x3, x0, 1
 0x0000000C	|	0x06800293	|	addi x5, x0, 104
 0x00000010	|	0x00508B23	|	sb x5, 22(x1)
 0x00000014	|	0x00208A23	|	sb x2, 20(x1)
 0x00000018	|	0x00308823	|	sb x3, 16(x1)
-------------------------------------------------------------------------
 	here:
 0x0000001C	|	0x01108203	|	lb x4, 17(x1)
 0x00000020	|	0xFE321EE3	|	bne x4, x3, here
 0x00000024	|	0x0000006F	|	jal x0, 0
-------------------------------------------------------------------------
 Data Dump
-------------------------------------------------------------------------
 0x0000002C	|	0x00020000
    ...
    assert get_register(dut, 3).value == 1
    assert get_register(dut, 4).value == 1
    assert get_register(dut, 5).value == 104
...
if not is_gate_level_tests():
    # this is not passing in gl_test
    @cocotb.test()
...
@cocotb.test()
async def test_uart_rx_single_baudrate_2 (dut):
    # change baudrate and do uart rx
    ...
    await run_program(dut, '''
 0x00000000	|	0x0400A083	|	lw x1, peripherals
 0x00000004	|	0x00200113	|	addi x2, x0, 2
 0x00000008	|	0x00100193	|	addi x3, x0, 1
 0x0000000C	|	0x06800293	|	addi x5, x0, 104
 0x00000010	|	0x00308023	|	sb x3, 0(x1)
 0x00000014	|	0x00508B23	|	sb x5, 22(x1)
-------------------------------------------------------------------------
 	wait_for_rx:
 0x00000018	|	0x01108183	|	lb x3, 17(x1)
 0x0000001C	|	0xFE219EE3	|	bne x3, x2, wait_for_rx
 0x00000020	|	0x0150C203	|	lbu x4, 21(x1)
 0x00000024	|	0x0160C303	|	lbu x6, 22(x1)
 0x00000028	|	0x0170C383	|	lbu x7, 23(x1)
 0x0000002C	|	0x4E200293	|	addi x5, x0, 1250
 0x00000030	|	0x00508B23	|	sb x5, 22(x1)
 0x00000034	|	0x0160C403	|	lbu x8, 22(x1)
 0x00000038	|	0x0170C483	|	lbu x9, 23(x1)
 0x0000003C	|	0x0000006F	|	jal x0, 0
-------------------------------------------------------------------------
 Data Dump
-------------------------------------------------------------------------
 0x00000044	|	0x00020000	
        ''', extra_func=add_uart_device, timeout_us=3000)
    ...
    assert get_register(dut, 3).value == 2
    assert get_register(dut, 4).value == 0xaa
    assert get_register(dut, 5).value == 1250
    assert get_register(dut, 6).value == 104
    assert get_register(dut, 7).value == 0
    assert get_register(dut, 8).value == 226
    assert get_register(dut, 9).value == 4

    assert_registers_zero(dut, 10)
...
@cocotb.test()
async def test_uart_rx_multiple_continuous_flow_control(dut):
    ...
    async def add_uart_device():
        ...
        await uart_sink.write([0b00110011])
        await uart_sink.wait()
        dut._log.info('writing done')

        dut._log.info('writing')
        await uart_sink.write([0b11001010])
        await uart_sink.wait()
        dut._log.info('writing done')

        
    await run_program(dut, '''
 0x00000000	|	0x0500A083	|	lw x1, peripherals
 0x00000004	|	0x00200113	|	addi x2, x0, 2
 0x00000008	|	0x00100193	|	addi x3, x0, 1
 0x0000000C	|	0x00400393	|	addi x7, x0, 4
 0x00000010	|	0x00600413	|	addi x8, x0, 6
 0x00000014	|	0x00308023	|	sb x3, 0(x1)
 0x00000018	|	0x00708823	|	sb x7, 16(x1)
-------------------------------------------------------------------------
 	wait_for_rx:
 0x0000001C	|	0x01108203	|	lb x4, 17(x1)
 0x00000020	|	0xFE221EE3	|	bne x4, x2, wait_for_rx
 0x00000024	|	0x00008023	|	sb x0, 0(x1)
 0x00000028	|	0x0150C283	|	lbu x5, 21(x1)
 0x0000002C	|	0x00008023	|	sb x0, 0(x1)
 0x00000030	|	0x00808823	|	sb x8, 16(x1)
 0x00000034	|	0x00708823	|	sb x7, 16(x1)
 0x00000038	|	0x00308023	|	sb x3, 0(x1)
-------------------------------------------------------------------------
 	wait_for_rx_2:
 0x0000003C	|	0x01108203	|	lb x4, 17(x1)
 0x00000040	|	0xFE221EE3	|	bne x4, x2, wait_for_rx_2
 0x00000044	|	0x00008023	|	sb x0, 0(x1)
 0x00000048	|	0x0150C303	|	lbu x6, 21(x1)
 0x0000004C	|	0x0000006F	|	jal x0, 0
-------------------------------------------------------------------------
 Data Dump
-------------------------------------------------------------------------
 0x00000054	|	0x00020000
        ''', extra_func=add_uart_device, timeout_us=3000)
    ...
    assert get_register(dut, 3).value == 1
    assert get_register(dut, 4).value == 2
    assert get_register(dut, 5).value == 0x33
    assert get_register(dut, 6).value == 0xca
    assert get_register(dut, 7).value == 4
    assert get_register(dut, 8).value == 6
    assert_registers_zero(dut, 9)
